...
export function NotFoundPage() {
  ...
  return (
    <div className="relative">
      ...
      <div className="flex min-h-[70vh] flex-col items-center justify-center px-4 text-center mt-4">
        <div className="relative mb-8">
          ...
          <div className="relative flex h-24 w-24 items-center justify-center rounded-2xl bg-white shadow-xl ring-1 ring-slate-200 dark:bg-slate-900 dark:ring-slate-800">
            <LoaderPinwheel className="h-12 w-12 text-primary animate-bounce" />
          </div>
        </div>
